...
function showHexagram(lines) {
    ...
    // Создаем контейнер с картинкой и линиями поверх
    hexagramContainer.innerHTML = `
        <div class="hexagram-overlay-container">
            <!-- Картинка-подложка (рамка) -->
            <img src="assets/hexagrams/hexagram-1.png" alt="Основа гексаграммы" class="hexagram-base-image">
            <!-- Контейнер для линий гексаграммы -->
